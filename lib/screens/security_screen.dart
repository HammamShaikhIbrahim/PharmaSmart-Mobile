...
class _SecurityScreenState extends State<SecurityScreen> {
  ...
  // دالة فحص قوة كلمة المرور الجديدة
  ...
  void _onSaveClicked() {
    if (_newPassController.text.isNotEmpty) {
      ...
      // فحص قوة كلمة المرور الجديدة قبل فتح نافذة التأكيد
      if (!_isPasswordValid(_newPassController.text)) {
        _showWarning(
          'كلمة مرور ضعيفة',
          'يجب أن تتكون كلمة المرور الجديدة من 8 أحرف على الأقل، وتحتوي على حرف إنجليزي كبير، حرف صغير، ورقم.',
        );
        return;
      }
    }
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildCleanField('رقم الهاتف', LucideIcons.phone, _phoneController, isPhone: true),
                        ],
                      ),
                    ),
                    const SizedBox(height: 30),
